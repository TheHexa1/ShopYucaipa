...
/**
 * Created by Vivek_Hexa on 18-Dec-16.
 */
...
//        AlertDialog.Builder alert = new AlertDialog().Builder
        ...
        alertDialog.setMessage("GPS is not enabled! For better performance of the app you need to enable the GPS." +
                "Click on Settings to enable it");
    ...
    public void onLocationChanged(Location location) {
        ...
        /*Location pointLocation = locationManager.getLastKnownLocation(LocationManager.NETWORK_PROVIDER);
